...
func (c *USocketMonClient) NewGetShockwaveMetric() *GetShockwaveMetricRequest {
...
// GetMetric - 获取监控数据
func (c *USocketMonClient) GetShockwaveMetric(req *GetShockwaveMetricRequest) (*GetShockwaveMetricResponse, error) {
	var err error
